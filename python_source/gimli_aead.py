...
@typechecked
def process_msg(message: vlbytes_t, mlen: int, s: state_t) -> (state_t, bytes_t):
...
@typechecked
def process_ct(ciphertext: vlbytes_t, mlen: int, s: state_t) -> (state_t, bytes_t):
